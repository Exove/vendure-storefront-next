...
export type ProductBySlugQuery = { __typename?: 'Query', product?: { __typename?: 'Product', name: string, description: string, languageCode: LanguageCode, assets: Array<{ __typename?: 'Asset', source: string, width: number, height: number }>, variants: Array<{ __typename?: 'ProductVariant', name: string, price: any, id: string }>, collections: Array<{ __typename?: 'Collection', name: string }>, optionGroups: Array<{ __typename?: 'ProductOptionGroup', name: string }>, translations: Array<{ __typename?: 'ProductTranslation', name: string, description: string }> } | null };
